<template>
    ...
    const redirectToNewRepair = (repair) => {
        console.log(repair.user.first_name)
        const preFilledDetails = {
            first_name: repair.user.first_name,
            last_name: repair.user.last_name,
            phone_number: repair.user.phone_number,
            email: repair.user.email,
            address: repair.user.address,
        };
