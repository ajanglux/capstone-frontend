        ...
        <div class="container">
            ...
            <div class="card-body">
                ...
                <div class="input-group mb-3">
                    ...
                    <input v-model="model.booking.phone_num" type="number" class="form-control" />
                </div>
                <div>
...
export default {
    ...
    methods: {
        getBookingDetails() {
            ...
            // Simulate a delay for fetching booking details
            setTimeout(() => {
                this.model.booking = mockBookingDetails;
            }, 500);
        },
        saveBooking() {
